...
let scoreTxt = {
    ...
    descText3: "this piece is a visual representation of a player's experience throughout the entirety of a play session (sum of eight mini-games). this analysis is done according to five different metrics calculated upon player interactions - presented on the left and further converted into the visual cues - presented above. these five calculated metrics reflect the players' personality in relation to the in-game content (being based on established correlations proposed by game-behavioral theory researchers) and while they can be combined into a more expressive and unified result, they represent singularly the characteristics mentioned above.",
    ...
    bottomText4: "play is defined as a free, unproductive, unpredicatable and self-contained activity, that consciously lives outside of seriousness and has \n no concrete goal and meaning, present in a variety of creative practices as well as in other aspects of everyday life. [re]connect serves \n as a vehicle  of reflection, appropriation and analysis of this concept, encouraging viewers to engage in more meanigfull and expressive \n experiences with  the help of digital media technologies.",
    topLeft3: "[re]connect"
}
