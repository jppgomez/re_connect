...
ptFlag.addEventListener("mouseenter", () => {
    ptFlag.style.backgroundImage = "url('re_connect/assets/flags/PT_Inv.svg')";
...
ptFlag.addEventListener("mouseleave", () => {
    ptFlag.style.backgroundImage = "url('re_connect/assets/flags/PT_Reg.svg')";
    fieldText.innerHTML = '[selecione idioma]';
});

engFlag.addEventListener("mouseenter", () => {
    engFlag.style.backgroundImage = "url('re_connect/assets/flags/UK_Inv.svg')";
...
engFlag.addEventListener("mouseleave", () => {
    engFlag.style.backgroundImage = "url('re_connect/assets/flags/UK_Reg.svg')";
